---
title: "Actividad No.5: Test 1 - Estructura de datos en R "
...
```{r}
enteros <- c(3, 7, 12, 5, 9, 1, 18, 4, 10, 22)
print(enteros)
```
...
```{r}
compClase <- c("Ana", "Luis", "María", "Carlos", "Sofía", "Diego", "Elena", "Jorge", "Paola", "Ricardo")
print(compClase)
```
